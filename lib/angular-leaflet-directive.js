...
"use strict";
L.Marker = L.Marker.extend({options: {id: ''}});
L.Path = L.Path.extend({options: {id: ''}});
L.Polygon = L.Polygon.extend({options: {id: ''}});
L.Polyline = L.Polyline.extend({options: {id: ''}});
            ...
            controller.getMap().then(function(map) {
                ...
                map.on("moveend", function(/* event */) {
                    ...
                    safeApply(leafletScope, function(scope) {
                        //TT: disabled due to coordinate drifts in IE10
                        //if (centerModel) {
    ...
    return {
        ...
        link: function(scope, element, attrs, controller) {
            ...
            controller.getMap().then(function(map) {
                ...
                //TT: this code gives problems (overflow) after adding d3layer
...
angular.module("leaflet-directive").factory('leafletLayerHelpers', function ($rootScope, $log, leafletHelpers) {
    ...
    var layerTypes = {
        ...
        betterwms: {
            mustHaveUrl: true,
            createLayer: function(params) {
                return L.tileLayer.betterWms(params.url, params.options);
            }
        },
        wmts: {
            mustHaveUrl: true,
        ...
        esri_map: {
            ...
            createLayer: function(params) {
                ...
                var layer = L.esri.dynamicMapLayer(params.url, params.options);
                return layer;
            }
        },
        esri_feature: {
...
angular.module("leaflet-directive").factory('leafletMarkersHelpers', function ($rootScope, leafletHelpers, $log) {
    ...
    return {
        ...
        createMarker: function(markerData) {
            ...
            var markerOptions = {
                id: isDefined(markerData.id) ? markerData.id : 'none', //TT
